...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO accounts (username, password, role, pw_flag) VALUES ('$new_cid', '$new_password', '$new_role', '1')";
...
Your username is <b>" .
        ...
        echo "This user has been created and an email with the login credentials have been sent.";
        include('footer.php');
    } else {
