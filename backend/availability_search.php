...
if (
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM availability WHERE cid = '" . mysqli_real_escape_string($conn, $_POST['cid']) ."' ORDER BY start ASC";
    ...
    <tr><th>Type</th><th>Start</th><th>End</th></tr>";
        ...
        $sql = "SELECT * FROM sessions WHERE student_cid = '" . mysqli_real_escape_string($conn, $_POST['cid']) ."' ORDER BY start ASC";
        $result = mysqli_query($conn, $sql);
